...
preamble-tier: 2
version: 1.0.0
description: "Design shotgun: generate multiple AI design variants, open a comparison board, collect structured feedback, and iterate. Use when: explore design variants; show me design options; visual design brainstorm. (gstack)"
triggers:
