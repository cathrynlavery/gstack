...
preamble-tier: 2
version: 1.0.0
description: "Keep gbrain current with this repo's code and refresh agent search guidance in CLAUDE.md. Wraps the gstack-gbrain-sync orchestrator with state Use when: sync gbrain; refresh gbrain; reindex repo; update gbrain. (gstack)"
triggers:
  - sync gbrain
  - refresh gbrain
  - reindex repo
