...
preamble-tier: 3
version: 1.0.0
description: "Remove the DebugBridge SPM package and all #if DEBUG wiring from an iOS app. Use when: clean the ios debug bridge; remove debugbridge; strip the gstack ios instrumentation. (gstack)"
allowed-tools:
  - Bash
  - Read
  - Edit
