...
preamble-tier: 1
version: 1.0.0
description: "Cross-model benchmark for gstack skills. Use when: cross model benchmark; compare claude gpt gemini; benchmark skill across models; which model should I use. (gstack)"
triggers:
