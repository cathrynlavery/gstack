...
preamble-tier: 2
version: 1.0.0
description: "Restore working context saved earlier by /context-save. Use when: resume where i left off; restore context; where was i; pick up where i left off; context restore. (gstack)"
allowed-tools:
  - Bash
  - Read
  - Glob
