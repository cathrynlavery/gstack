...
preamble-tier: 4
version: 1.0.0
description: "Ship workflow: detect + merge base branch, run tests, review diff, bump VERSION, update CHANGELOG, commit, push, create PR. Use when: ship it; create a pr; push to main; deploy this. (gstack)"
allowed-tools:
  - Bash
  - Read
  - Write
