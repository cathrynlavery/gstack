...
name: guard
version: 0.1.0
description: "Full safety mode: destructive command warnings + directory-scoped edits. Use when: full safety mode; guard against mistakes; maximum safety. (gstack)"
triggers:
  - full safety mode
